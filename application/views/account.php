          ...
          <div class="nk-content-body">
              <div class="nk-content-wrap">
                  <div class="nk-block-head nk-block-head-lg">
                      <div class="nk-block-head-sub"><a class="back-to" href="<?php echo base_url();?>"><em
                                  class="icon ni ni-arrow-left"></em><span>Dashboard</span></a></div>
                      <div class="nk-block-between-md g-4">
                          <div class="nk-block-head-content">
                              <h2 class="nk-block-title fw-normal">Manage Subscription</h2>
                              <div class="nk-block-des">
                                  <p>Your subscription renews on Oct 28, 2020 <span class="text-soft">(11 months 16 days
                          ...
                          <div class="nk-block-head-content">
                              <ul class="nk-block-tools justify-content-md-end g-4 flex-wrap">
                                  <li class="order-md-last">
                                      <a href="#" class="btn btn-auto btn-dim btn-danger" data-toggle="modal"
                                          data-target="#subscription-cancel"><em
                                              class="icon ni ni-cross"></em><span>Cancel Subscription</span></a></li>
                                  <li>
                                      <div class="custom-control custom-switch">
                                          <span class="badge badge-success badge-pill p-1 pl-3 pr-3">Active</span>
                                      </div>
                                  </li>
                              </ul>
                          </div>
                                  ...
                                  <div class="card-inner-group">
                                      <div class="card-inner">
                                          ...
                                          <div class="sp-plan-desc sp-plan-desc-mb">
                                              <ul class="row gx-1">
                                                  <li class="col-sm-4">
                                                      <p><span class="text-soft">Incoming Messages</span> 100</p>
                                                  </li>

                                                  <li class="col-sm-4">
                                                      <p><span class="text-soft">$1 per Message</span> $100</p>
                                              ...
                                              <ul class="row gx-1">
                                                  <li class="col-sm-4">
                                                      <p><span class="text-soft">Outgoing Messages</span> 200</p>
                                                  </li>

                                                  <li class="col-sm-4">
                                                      <p><span class="text-soft">$1 per Message</span> $200</p>
                                                  </li>
                                      ...
                                      <div class="card-inner">
                                          <div class="sp-plan-head-group">
                                              <div class="sp-plan-head">
                                                  <h6 class="title">Recharge Now</h6>
                                              </div>
                                              <div class="sp-plan-amount">
                                                  <span class="sp-plan-status text-success">Balance</span> <span
                                                      class="amount">$599.00</span>
                                              </div>
                                          </div>
                                          <div class="sp-plan-payopt">
                                              <div class="cc-pay">
                                                  ...
                                                  <ul class="cc-pay-method">
                                                      <li class="cc-pay-dd ">
                                                          <div class="form-group">
                                                              ...
                                                              <div class="form-control-wrap">
                                                                  <input type="text" class="form-control" value="599"
                                                      ...
                                                      <li class="cc-pay-btn">
                                                          <a href="#" class="btn btn-secondary"><span>Pay Now</span> <em
                              ...
                              <div class="card card-bordered card-full d-none d-xl-block">
                                  <div class="nk-help-plain card-inner text-center">
                                      ...
                                      <div class="nk-help-text">
                                          ...
                                          <p class="text-soft">Ask a question or file a support ticketn or report an
                                              issues. Our team support team will get back to you by email.</p>
                                      </div>
                                  ...
                                  <div class="card-inner">
                                      <div class="nk-help">
                                          ...
                                          <div class="nk-help-text">
                                              ...
                                              <p class="text-soft">You can get additionally weekly maintainance with
                                                  premium support, only <span class="ext-base">$99.00</span> per year.
                                              </p>
                                          </div>
                                          <div class="nk-help-action">
                                              <a href="#" class="btn btn-lg btn-primary">Get Support Now</a>
                                  ...
                                  <tr class="tb-tnx-item">
                                      ...
                                      <td class="tb-tnx-amount">
                                          ...
                                          <div class="tb-tnx-status"><span
                                                  class="badge badge-dot badge-success">Paid</span></div>
                                      </td>
                                  </tr><!-- .tb-tnx-item -->
                                  <tr class="tb-tnx-item">
                                      <td class="tb-tnx-id">
