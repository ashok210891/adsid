...
<div style="font-size:14px; color:#333333; line-height:1.7;">
    ...
    <p style="margin:0 0 12px 0;">
        We would like to inform you that your registration on the ADSID (Aerospace &amp; Defence Supplier
        Identification Dashboard) has been successfully completed, and a user account has been created for you.
        However, it has been observed that the portal has not yet been accessed from your account.
    </p>

    <p style="margin:0 0 12px 0;">
        The ADSID portal provides several valuable opportunities and resources that will be beneficial. You are kindly
        encouraged to log in at your earliest convenience and explore the opportunities available on the platform.
    </p>

    <p style="margin:0 0 12px 0;">
        Should any assistance be required in accessing your account, support will be gladly provided.
    </p>

    <p style="margin:0 0 18px 0;">
        Thank you, and your active participation on the portal is greatly anticipated.
    </p>
